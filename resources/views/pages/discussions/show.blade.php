...
<section class="bg-gray pt-4 pb-5">
    <div class="container">
        ...
        <div class="row">
            <div class="col-8 col-lg-0 mb-5 mb-lg-0">
                <div class="card card-discussions mb-5">
                    <div class="row">
                        <div class="col-1 d-flex flex-column justify-content-start align-items-center">
                            <a href="#">
                                <img src="{{ url('assets/images/icon-like.png') }}" alt="like" class="like-icon mb-1">
                            </a>
                            ...
                            <div class="row align-items-start justify-content-between">
                                ...
                                <div class="col-5 col-lg-3 d-flex">
                                    <a href="#" class="card-discussions-show-avatar-wrapper flex-shrink-0 rounded-circle overflow-hidden me-1">
                                        <img src="{{ url('assets/images/circle-avatar.png') }}" alt="" class="avatar">
                                    </a>
                ...
                <div class="fw-bold text-center">Please <a href="#" class="text-primary">Sign In</a> or <a href="#" class="text-primary">create an account</a> to participate in this discussions.</div>
            </div>
