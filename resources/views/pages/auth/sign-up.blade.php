...
@section('body')
    <section class="bg-gray vh-100">
        <div class="container">
            <div class="row pt-5 justify-content-">
                ...
                <div class="col-12 col-lg-3 h-100">
                    <a href="#" class="nav-link mb-5 text-center">
                        <img src="{{ url('assets/images/logo-blue.png') }}" alt="Laracuss Logo" class="h-32px">
                    </a>
                    <div class="card mb-5">
                        <form action="#">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control border-end-0 pe-0 rounded-0 rounded-start" id="password" name="password" placeholder="password">
