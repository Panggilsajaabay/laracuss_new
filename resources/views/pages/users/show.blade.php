...
@section('body')
    <section class="bg-gray pt-4 pb-5">
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-4 mb-5 mb">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-5 col-lg-4">
                                                <div class="avatar-sm-wrapper d-inline-block">
                                                    <a href="#" class="me-1">
                                                        <img src="{{ url('assets/images/circle-avatar.png') }}" alt="fajarwz" class="avatar rounded-circle">
                                                    </a>
                                                </div>
                                                <span class="fs-12px">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col">
                                        ...
                                        <span class="fw-bold text-primary">
                                            <a href="#">How to add a custom validation</a>
                                        </span>
                                    </div>
                                </div>
                            </div>
