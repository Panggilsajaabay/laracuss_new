<nav class="navbar navbar-dark navbar-expand-lg bg-primary">
            <div class="container flex justify-content-between">
                <a class="navbar-brand" href="{{ route('home') }}">
                 <img class="h-32px" src="{{ url('assets/images/logo.png') }}" alt="">
                </a>
                ...
                <ul class="navbar-nav mx-0 mx-lg-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Route::currentRouteName() === 'discussions.index' ? 'active' : '' }}" href="{{ route('discussions.index') }}">Discussion</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-nowrap {{ Route::currentRouteName() === '' ? 'active' : '' }}" href="#">About Us</a>
                    </li>
                </ul>
